<?php
    ...
    foreach($match_info as $key => $value)
    {
        ...
        echo "<td width=25% style=\"vertical-align:middle;$tdstyle\">联赛id:$ln</td>";
        ...
        $gameNum = $r1 + $r2;
        if($gameNum <=1 ) $bo = 1;
        elseif($gameNum <=3) $bo = 3;
        elseif($gameNum <=5) $bo = 5;
        else $bo = 7;
        
        echo "<td width=25% style=\"vertical-align:middle\">BO$bo</td>";

        echo "<td width=35% style=\"$tdstyle\">$aside<font color=green><b>&nbsp;$r1:$r2&nbsp;</b></font>$bside</td>";
        echo "</tr>\n";
    }
    if($lastday != "")
    {
